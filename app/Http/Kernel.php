...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'company.status' => \App\Http\Middleware\ValidateCompanyStatus::class,
        'employee.ownership' => \App\Http\Middleware\EnsureEmployeeOwnership::class,
    ];
}
